<%-- 
    Document   : errorEditarDonacion
    Created on : abr 17, 2020, 2:39:41 p.m.
    Author     : Abel_
--%>
            ...
            <div class="hero-body" style=" background-image: url(styles/Imagenes/bg4.jpg)">
                ...
                <div class="container has-text-centered">
                    ...
                    <h2 class="subtitle" style=" align-content: center; font-family: initial; font-style: oblique; color: white">
                        Lo sentimos, no puedes borrar o editar esta solicitud, ya que ha sido tomada una desición por parte de los administradores
                    </h2>                    
                </div>
            </div>
        </section>        
